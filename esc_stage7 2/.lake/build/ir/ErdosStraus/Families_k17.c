...
// Module: ErdosStraus.Families_k17
// Imports: Init ErdosStraus.FamiliesK10Common ErdosStraus.QRCommon
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_ErdosStraus_Families__k17(uint8_t builtin, lean_object* w) {
lean_object * res;
